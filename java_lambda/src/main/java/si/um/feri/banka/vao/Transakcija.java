...
public class Transakcija implements Serializable {
    ...
    public static final int TIP_TRANSAKCIJE_DVIG=0;
    public static final int TIP_TRANSAKCIJE_POLOG=1;
    public static final int TIP_TRANSAKCIJE_PRENOS_MED_RACUNI=2;
    ...
    private int tipTransakcije=TIP_TRANSAKCIJE_PRENOS_MED_RACUNI;
